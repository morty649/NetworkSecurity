...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        # Read data from mongodb as collection and convert it into dataframe 
    ...
    def export_data_into_feature_store(self,dataframe:pd.DataFrame):
        try:
            ...
            #create a folder for storing the taken content from mongodb
    ...
    def split_data_as_train_test_split(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Exporting train and test sets done")
